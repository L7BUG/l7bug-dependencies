...
/**
 * StringHashModShardingAlgorithm
 *
 * @author Administrator
 * @since 2025/9/12 12:20
 */
public final class StringHashModShardingAlgorithm implements StandardShardingAlgorithm<Comparable<?>> {

	@Override
	public String doSharding(Collection<String> availableTargetNames, PreciseShardingValue<Comparable<?>> shardingValue) {
		int hashCode = shardingValue.getValue().toString().hashCode();
		int indexOf = Math.abs(hashCode) % availableTargetNames.size();
		int index = 0;
